...
public class Vista extends javax.swing.JFrame {
    ...
    private void cmdRegistroActionPerformed(java.awt.event.ActionEvent evt) {                                            
        ...
        p.NuevoContacto(name, mail, mail, mail, mail, mail);        
        updateTabla(); 
    }                                           
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        ...
        String codigo = String.valueOf(tabla.getValueAt(fila, 0));
        String name = txtname.getText();
        String fijo = txtFIjo.getText();
        String movil = txtFIjo.getText();
        String giro = txtgiro.getText();
        String dir = txtDir.getText();
        String mail = txtmail.getText();        
        p.ActualizarContacto(mail, mail, mail, mail, mail, mail, mail);
        updateTabla(); 
        }
    }                                        

    private void formWindowActivated(java.awt.event.WindowEvent evt) {                                     
       this.setTitle(" AGENDA BASE DE DATOS ");
       int w = this.getWidth();
       ...
       jPanel4.repaint();
       */ 
       /* el siguiente codigo es para cargar IMAGENES
          en los botonos no es necesario para el funcionamiento
    ...
    private void updateTabla(){             
        String[] columNames = {"#","Nombre Completo","Direccion","E-mail", "Tel.Celular", "Tel.Casa", "Giro"};  
